...
### 2. 文章详情页
创建一个文章详情页面，页面包含一个WebView，在点击文章列表的item时跳转到这个页面，从外面传入item信息，在该页面中使用url加载网页。
...
### 5.新建一个设置页面，并在当前项目的合适位置添加设置按钮和跳转
1. **添加第一个设置项，可以设置当前主题色，添加几个常用的颜色供用户选择**
2. **点击设置主题色后跳转到一个新的页面，颜色选择页面**
3. **对背景颜色也做主题色的切换功能**
